...
public class StopRanging extends CarmenAction {
    private static final String TAG = "com.dff.cordova.plugin.carmen.action.StopRanging";
    ...
    public void run() {
        ...
        try {
            ...
            Message msg = Message.obtain(null, AbstractCarmenBeaconManager.WHAT.STOP_RANGING.ordinal());
